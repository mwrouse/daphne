...
Daphne is a portable tool that allows you to easily create static blogs. Daphne allows you to easily create your own templates to fully customize your website. Very similar to Jekyll, Daphne takes out some complexity of such a complex tool. 
